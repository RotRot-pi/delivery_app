class ApiLink {
  static String server = "http://10.0.2.2/ecommerce_from_host/delivery";
  ...
  // ====================== Order ======================= //
  static String viewAcceptedOrder = "$server/order/accepted.php";
  static String viewPendingOrder = "$server/order/pending.php";
  ...
  static String orderDone = "$server/order/done.php";
